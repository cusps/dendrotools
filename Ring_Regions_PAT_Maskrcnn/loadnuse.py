...
for box in prediction[0]['boxes']:
    box_img.rectangle(box.cpu().numpy(), outline="pink", width=5)

img_img.show()
# img_img.save(r"../../vessel_bbox_demonstration_CCS717B_1910_780pmm.PNG")
#
...
for point in points:
    img_outline.ellipse((point[0] - 4, point[1] - 4, point[0] + 4, point[1] + 4), fill="red")
